...
<div class="page-header navbar navbar-fixed-top">
    ...
    <div class="page-header-inner ">
        ...
        <div class="page-logo">
            <a href="">
                {{--<img src="{{ asset('logo.png') }}" alt="logo" class="logo-default"style="width: 157px;    margin-top: 5px;" /> </a>--}}
            {{--    <img src="{{ asset('uploads/files/'.\App\Models\Backend\WebSetting::getSetting('logo')) }}" alt="logo" class="logo-default"style="width: 157px;    margin-top: 5px;" /> </a>
            --}}
            </a>
